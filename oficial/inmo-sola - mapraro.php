...
function initMap() {
  var chicago = new google.maps.LatLng(parseFloat(lat),parseFloat(lng));//41.850, -87.650);
...
function project(latLng) {
  ...
  return new google.maps.Point(
    ...
    <script async defer
         src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAAqX8qzk0P4Hn8FfgF0rewnZzhCAg008E&signed_in=true&callback=initMap">
    </script>
