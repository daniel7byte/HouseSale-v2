              ...
              <div class="sidebar">
                ...
                <div class="widget js-widget widget--sidebar">
                  ...
                  <div class="widget__content">
                    ...
                    <?php if ($conCookies): ?>
                      <script>
                        setForm("<?=($_GET['formId'] != '-' ? $_GET['formId'] : '')?>", "<?=($_GET['formDateFilter'] != '-' ? $_GET['formDateFilter'] : '')?>", "<?=($_GET['formZipcode'] != '-' ? $_GET['formZipcode'] : '')?>", "<?=($_GET['formCounty'] != '-' ? $_GET['formCounty'] : '')?>", "<?=($_GET['formCity'] != '-' ? $_GET['formCity'] : '')?>", "<?=($_GET['formPriceMin'] != '-' ? $_GET['formPriceMin'] : '')?>", "<?=($_GET['formPriceMax'] != '-' ? $_GET['formPriceMax'] : '')?>", "<?=($_GET['formSystemFiltro'] != '-' ? $_GET['formSystemFiltro'] : '' )?>");
                      </script>
                    <?php endif; ?>
                    <!-- end of block-->
                    <!-- END SEARCH-->
