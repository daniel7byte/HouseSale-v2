...
try {
	...
	if($d1){
	$sqlquery = $sqlquery. " and dato2='$d1' ";
	}
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" version="XHTML+RDFa 1.0" dir="ltr" class="js"><head profile="http://www.w3.org/1999/xhtml/vocab">
  <meta http-equiv="X-UA-Compatible" content="IE=9; IE=8; IE=7; IE=EDGE">
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<link rel="shortcut icon" href="img/favicon.ico" type="image/vnd.microsoft.icon">
<meta name="Generator" content="Drupal 7 (http://drupal.org)">
  <title>Demo | Concasa V1</title>
...
<div id="body-container" style=" width:100%; background-color:lime;">
  ...
  <div class="breadcrumbs" style=" height:27px; margin-bottom:10px; text-transform:uppercase; font-size: 14px;   "><p class="current"><?php echo $v7; ?></p></div>   
 ...
 <div class="panel-region-top">
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 722px; height: 456px; overflow: hidden; visibility: hidden; background-color: #24262e;">
        <!-- Loading Screen -->
...
<div id="sidebar-right-top"  style="padding:0px 1px 0px 0px!important">
...
<div id="block-bcscm-bcscm-sidebar" class="block">

<button class="btne btn-entrar"  onclick="window.location.href='index.php'" style="
		...
		<div id="" style=" height:400px;">
			...
			<div id="" class="block">
				<div class="block-info">
					<div class="view view-promotion-banner view-id-promotion_banner view-display-id-block view-dom-id-2">
					  
					 
						<ul class="banner-promotion-slide bcsc-cyle-processed" style="position: relative;">     
						  
								<li class="views-row views-row-1 views-row-odd views-row-first" style="position: absolute; top: 0px; left: 0px; display: block; z-index: 5; opacity: 1; width: 210px; height: 400px; overflow:hidden;">
									<div class="block banner banner-right" style="">
										<img src="img/banner-210x400.jpg" width="210" height="400" alt="">  
									</div>
								</li>
