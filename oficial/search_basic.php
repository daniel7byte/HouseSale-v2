            ...
            <div class="row">
              ...
              <div class="site site--main">
                <header class="site__header">
                  <h1 class="site__title" style="font-size: 28px!important;"><?php echo LISTING_RESULT ?> : <strong id="numRecords">...</strong> </h1>
                  <p id="search-string">
                      ...
                      <div class="listing listing--grid listing--lg-4 js-properties-list" id="articles">
                        ...
                        <?php if (isset($_GET['confirmado'])): ?>
                            ...
                            if ($_GET['id'] != '') {
                                ...
                                $query = $mysql->prepare("SELECT * FROM datoscasas WHERE dato7 LIKE :street AND dato24 LIKE :zipcode AND dato6 = 'A'");
                                $query->execute([
                                    ':street' => "%$street%",
                                    ':zipcode' => "%$zipcode%",
                                ]);
              ...
              <div class="sidebar">
                ...
                <div class="widget js-widget widget--sidebar">
                  ...
                  <div class="widget__content">
                    <!-- BEGIN SEARCH-->
                    <form method="get" action="search_basic.php" id="searchForm" class="form form--flex form--search js-search-form form--sidebar">
                      <div class="row">
                        ...
                        <script>
                            $( "form" ).submit(function( event ) {
                                ...
                                sweetAlert("", "Enter some value!", "error");
                        ...
                        <div class="form-group" style="display:block;">
                            <label for="id" class="control-label">Street</label>
                            <input class="form-control" type='text' name="street" id="street" value="<?=$_GET['street']?>">
                        </div>

                        <div class="form-group">
                            <label for="zipcode" class="control-label"><?php echo FORM_LABEL2; ?></label>
                            <input class="form-control" type='text' name="zipcode" id="zipcode" value="<?=$_GET['zipcode']?>">
                        </div>

                        <div class="form-group" style="display:block;">
                            <label for="id" class="control-label">ID</label>
                            <input class="form-control" type='text' name="id" id="id" value="<?=$_GET['id']?>">
                        </div>
                        ...
                        <input type="hidden" name="systemFiltro" value="">
                        <input type="hidden" name="confirmado" value="1">

                        <div class="form__buttons form__buttons--double">
                          <button type="submit" class="form__submit" style="width: 100%;"><?php echo FORM_BTN2 ?></button>
                        </div>
                      </div>
                    </form>
                    <!-- end of block-->
