...
<html>
  ...
  <body style="padding-top: 60px;">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2>Formulario GAFMLS - AGREGAR REGISTROS</h2>
          <hr>
          <div class="well">
            <form id="myForm" class="form-horizontal" action="gafmls_procesarAgregar.php" method="post" autocomplete="off" enctype="multipart/form-data">
              <fieldset>
