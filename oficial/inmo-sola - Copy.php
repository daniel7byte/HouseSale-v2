...
<!-- Fin Categorias -->				
  ...
  <div class="col-sm-9 col-sm-push-3" >
          ...
          <article class="col-main" style="width:90%; margin:auto 0; background-color:#dedede;">
...
<div class="panel-region-top">
            ...
            <div class="">
                <div class="span3">
                    ...
                    <table>
                        ...
                        <tr>
                            <th>Price:</th>
                            <td class="price" style="font-size:18px; color:#000;">
                               <strong> <?php echo '$'.$v5; ?></strong>
                            </td>
                        ...
                        <tr>
                            <th>Bedrooms:</th>
                            <td style="padding:0px 0px 0px 10px"><?php echo $v12; ?></td>
                        </tr>

                        <tr>
                            <th>Bathrooms:</th>
                             <td style="padding:0px 0px 0px 10px"><?php echo $v13; ?></td>
                        </tr>
 ...
 <div style=" position:relative; width:99.9%; min-height:35px; margin-top:15px;">	</div>
...
<div style=" position:relative; width:99.9%; min-height:45px; margin-top:15px;">	</div>
